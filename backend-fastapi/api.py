...
MEILI_MASTER_KEY = os.environ.get("MEILI_MASTER_KEY", "dCR0hml5LZ_dagKTTssIaJT4i0Tdx5dbxZHcw5x5QAc") # Set your master key if you have one (recommended for production)
